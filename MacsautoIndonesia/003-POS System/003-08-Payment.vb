...
Public Class PaymentSubmittedEventArgs
    ...
    Private ReadOnly _paymentForm As _003_08_Payment

    ReadOnly Property PaymentForm() As _003_08_Payment
        Get
            Return _paymentForm
        End Get
    End Property

    Public Sub New(ByVal paymentForm As _003_08_Payment)
