Public Class _009_08_Balanced_Sheet
    ...
    Private Sub getPNL()
        ...
        While reader.READ
            ...
            End If
            BSGrid.Rows.Add("", "", "", "", "", "", result, "", "", "", reader(0))

        End While
    End Sub
    Private Sub CountTotal()
        Dim i As Integer
        Dim sumAsset, sumLiaEqui As Double
        sumAsset = 0
        sumLiaEqui = 0
        For i = 0 To BSGrid.Rows.Count - 1
            MsgBox(BSGrid.Rows(i).Cells(5).Value)
            sumAsset = sumAsset + Double.Parse(BSGrid.Rows(i).Cells(5).Value)
            sumLiaEqui = sumAsset + Double.Parse(BSGrid.Rows(i).Cells(10).Value)
        Next i
        BSGrid.Rows.Add("", "", "", "", sumAsset, "", "", "", "", "", "", sumLiaEqui)
