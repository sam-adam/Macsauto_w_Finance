Public Class _007_02_Petty_Cash
    ...
    Private Function getCurrentAmt()
        reader = ExecQueryReader("SELECT (SUM(CASE WHEN PSTKY = '10' THEN PSAMT ELSE '0' END)- SUM(CASE WHEN PSTKY = '20' THEN PSAMT ELSE '0' END))'amount' FROM JOURHD A, JOURDT B,GLACCOUNTMS C  WHERE A.DOCID = B.DOCID AND C.GLNUM =B.GLNUM  and DSTAT <> 'X' AND B.GLNUM = '" + pcact + "' GROUP BY  B.GLNUM")
