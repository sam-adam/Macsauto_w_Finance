Public Class _005_03_Product
    ...
    Private Sub _005_03_Product_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        loadTable("SELECT idpdt as 'PRODUCT #',pdtds AS 'PRODUCT DESCRIPTION',uodsc AS 'UOM',glnum as 'GL. Act.',c.iscnsm as 'Consumable'  from hproduct a, uom b, productType c where a.iduom = b.iduom and a.idptp = c.idptp", productGrid)
        Marking(productGrid)
